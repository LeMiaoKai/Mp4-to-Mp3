...
def choose_mp4_filepath():
    ...
    status_info["text"] = f"MP4 目录中的文件已经添加。"
...
# 开始转换
more_BT = Button(root, text="开始转换", font="Calibri 11 bold", command=threading_convert, bg="greenyellow", fg="black")
more_BT.pack(fill = X)
...
def clean_listbox():
	...
	g_mp4_file_list=[]
	# 在状态样栏中显示状态
	status_info["text"] = f"当前目录中的MP4文件已经清空，请重新选择MP4文件所在目录 "

clean_list_BT = Button(listboxframe, text="删除全部", 	command=clean_listbox,  	background="greenyellow", fg="black", font="Arial 10 bold")
...
select_all_BT = Button(listboxframe, text="删除已完成", command=delete_finished,  	background="greenyellow", fg="black", font="Arial 10 bold")
...
# 删除选中记录
select_all_BT = Button(listboxframe, text="删除选中", command=delete_selected,  	background="greenyellow", fg="black", font="Arial 10 bold")
select_all_BT.pack(side = RIGHT, padx=8, pady=8)
...
# 反向选择
sort_list_BT = Button(listboxframe, text="反向选择",command=list_box_inverse,  	background="greenyellow", fg="black", font="Arial 10 bold")
...
# 全部不选
select_all_BT = Button(listboxframe, text="全部不选",	command=select_none,  		background="greenyellow", fg="black", font="Arial 10 bold")
select_all_BT.pack(side = RIGHT, padx=8, pady=8)
...
# 全部选中
select_all_BT = Button(listboxframe, text="全部选中", 	command=select_all,  		background="greenyellow", fg="black", font="Arial 10 bold")
select_all_BT.pack(side = RIGHT, padx=8, pady=8)
...
status_author = Label(statusframe, text='|Author Email: LeMiaokai@gmail.com', anchor =W, bg=bg_color, font="Calibri 11 bold")
